...
def convert_mat2npy(file_path,start_time,duration,amplitude_threshold,window_width,signal_key):
    ...
    arranged_pulses_tdx1 = arrange_trigger_points(triggers, window_width, mat_data['TDX1'][0], fs)
    print(f"arranged_pulses_tdx1.shape: {arranged_pulses_tdx1.shape}")
    arranged_pulses_tdx2 = arrange_trigger_points(triggers, window_width, mat_data['TDX2'][0], fs)
    #print(f"arranged_pulses_tdx2.shape: {arranged_pulses_tdx2.shape}")  
    arranged_pulses_tdx3 = arrange_trigger_points(triggers, window_width, mat_data['TDX3'][0], fs)
    #print(f"arranged_pulses_tdx3.shape: {arranged_pulses_tdx3.shape}")  
    arranged_pulses_tdx4 = arrange_trigger_points(triggers, window_width, mat_data['TDX1_enlarged'][0], fs)
    #print(f"arranged_pulses_tdx4.shape: {arranged_pulses_tdx4.shape}")  
    arranged_pulses = np.stack((arranged_pulses_tdx1, arranged_pulses_tdx2, arranged_pulses_tdx3, arranged_pulses_tdx4), axis=2)
